...
clustlist = c( 
    ...
    "VarSelCluster",  "kmedians", "angle", "ejaccard", "hardcl",  "cckmeans" )
fnames = getNamesFromDataframe( "Random", mydf )
```
...
cclusterobj = consensusSubtypingTrain( cohortbl, fnames, clustlist, 2, verbose=TRUE )
...
clustdata = consensusSubtypingPredict( mydf, fnames, clustlist, clustmodels,
  reorderers = reoModels, mvcl=mvcl, 
  idvar='Id', visitName='visit', baselineVisit='V0')
cocanames = getNamesFromDataframe( mvcl, clustdata, exclusions="_mem")
