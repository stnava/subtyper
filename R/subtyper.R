...
assess_idp_consistency <- function(df,
  ...
  system_prompt <- paste0(
    ...
    postcent.ctx = postcentral gyrus; inf.parietal.ctx = inferior parietal cortex; parahippocampal cortex is part of the medial temporal lobe, located just adjacent to the hippocampus; pericalcarine is part of the primary visual cortex (V1) located along the calcarine sulcus in the occipital lobe;"
  )
...
.get_master_dictionary <- function() {
  maps <- c(
    ...
    "pontine crossing tract a part of mcp" = "Pontine Crossing Tract (part of MCP)",
